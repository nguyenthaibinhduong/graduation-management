<template>
    ...
    <div v-if="!isImport" class="grid grid-cols-2 mt-5 gap-x-10">
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 gap-10">
          ...
          <MyInput
            v-model="newStudent.user.birth_date"
            :maxDate="maxDate"
            title="Ngày sinh"
            id="date_of_birth"
            type="date"
      ...
      <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 gap-10">
          ...
          <div class="card flex flex-col items-center gap-6">
            ...
            />
            <img
              v-if="src || newStudent.user.avatar"
              :src="src ?? newStudent.user.avatar"
              alt="Image"
  ...
  <ImportExportDialog
    ...
    @export="exportData"
    @import="handleImport"
    :isShowUpload="importValue?.department_id != '' && importValue?.major_id != ''"
  >
    <template #import>
        ...
        <div class="w-full grid grid-cols-4 gap-4 bg-white p-3 rounded-md shadow-sm text-sm">
          ...
          <div class="flex flex-col gap-y-1">
            ...
            <MyInput
              ...
              id="department"
              type="select"
              v-model="importValue.department_id"
              :options="departments"
              optionLabel="name"
              optionValue="id"
              placeholder="Chọn khoa"
...
const newStudent = ref({
  code: '',
  user: { email: '', fullname: '', birth_date: null, phone: '', avatar: '' },
  major_id: null,
  department_id: null,
})
...
const editStudent = (dataEdit) => {
  ...
  newStudent.value = {
    ...
    department_id: departments.value.find((item) => item.id == clonedData.department.id),
  }
