<template>
  <div class="p-4">
      ...
      <template #header>
        <div class="flex flex-wrap items-center justify-between py-3 border-b">
          ...
          <div class="flex items-center gap-3">
            <Select v-model="limit" :options="[2, 5, 10, 20]" @change="onLimitChange" placeholder="Hiện bản ghi" class="w-45" />
    ...
    <Paginator v-if="total > limit" :rows="limit" :totalRecords="total" :first="(page - 1) * limit" @page="onPageChange" />
  </div>
</template>
